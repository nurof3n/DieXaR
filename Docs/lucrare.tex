...
introdus de NVIDIA în 2018, prin intermediul arhitecturii Turing\footnote{\label{turing}https://images.nvidia.com/aem-dam/en-zz/Solutions/design-visualization/technologies/turing-architecture/NVIDIA-Turing-Architecture-Whitepaper.pdf. Accesat 06.10.2024.}.
Tot în același an, Microsoft a anunțat DirectX Raytracing\footnote{\label{dxr}https://devblogs.microsoft.com/directx/announcing-microsoft-directx-raytracing/. Accesat 06.10.2024.} (DXR),
...
în perioada 2022-2030\footnote{https://www.grandviewresearch.com/industry-analysis/gaming-industry. Accesat 06.10.2024.}.
...
\begin{figure}[ht]
	...
	\label{fig:ssr-good}
\end{figure}
\footnotetext{\label{continuum}Shader folosit: \textcopyright https://continuum.graphics/. Accesat 06.10.2024.}
...
\end{figure}
\footnotetext{\textcopyright Nvidia Corporation: https://blogs.nvidia.com/blog/geforce-rtx-real-time-ray-tracing/. Accesat 06.10.2024.}
...
\begin{figure}[ht]
	...
	\label{fig:bf5-rtx}
\end{figure}
\footnotetext{\textcopyright Nvidia Corporation: https://www.youtube.com/watch?v=WoQr0k2IA9A. Accesat 06.10.2024.}
